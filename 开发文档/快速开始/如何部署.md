...
| 名称 | 详情 | 地址 |
| :--- | :--- | :--- |
| **Prompt** | ST卡 + 自改 | <https://file.leewater.online/s/AYID> |
...
| 名称 | 详情 | 地址 |
| :--- | :--- | :--- |
| **XutheringWavesUID** | 鸣潮查询插件 | <https://github.com/Loping151/XutheringWavesUID> |
| **Gscore 部署文档** | WWUID 的核心框架 | <https://docs.sayu-bot.com> |
| **XWUID 部署文档** | XutheringWavesUID 部署文档 | <https://blog.gufei.life/posts/life/wwbot> |

#### LLM (大型语言模型) 相关

| 名称 | 详情 | 地址 |
| :--- | :--- | :--- |
| **主模型** | Gemini 3 Flash | <https://ai.google.dev> |
